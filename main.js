		...
		await asyncForEach(plantArray, async (plant) => {
			...
			if (this.config.service === 'forecastsolar') {
				if (this.hasApiKey) {
					...
					url = `https://api.forecast.solar/estimate/${this.pvLatitude}/${this.pvLongitude}/${plant.tilt}/${plant.azimuth}/${plant.peakpower}?time=utc&damping=${plant.dampingm},${plant.dampinge}`;
				}
